...
My  research  is primarily centered around the nanoscale heat generation and transport behavior of electrochemical solid-liquid interfaces, with specific emphasis on batteries and supercapacitors. My work involves **exploring the** **microscopic heat generation/transfer mechanisms** **and** **regulatory strategies from the molecular/atomic perspective.** Additionally, I maintain a keen interest in harnessing the power of emerging **machine learning potentials to investigate chemical reactions at solid-liquid interfaces**.
