...
4. Finally, the final total training structure is 100+60+50=210.(note: AIMD results were obtained using the **PAW_PBE H 15Jun2001** and **PAW_PBE O 08Apr2002** pseudopotentials in **AIMD_ML**.)
